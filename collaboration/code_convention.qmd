...
Each R - session is treated as disposable. Always start R with a blank slate (no data saved in memory). It is preferred to start new sessions often and regularly.
