...
- Opportunity to skills in:
  - Data analysis and statistical testing 
  - Working with large dataset compilations from global databases 
  - Advanced coding protocols, particularly in [R](https://en.wikipedia.org/wiki/R_(programming_language))
...
- A tax-free PhD stipend of 20,500 CZK/month (ca 830 EUR as of Jan 2024).
  - I hope to be able to acquire additional funding during the PhD project
...
# I require
- A master's or equivalent degree/diploma in a project-related field (e.g., ecology, geography, palaeoecology, botany, bioinformatics, biostatistics, environmental sciences). However, I also encourage holders of degrees in statistics, data science, or computer science to apply
- Proficiency in spoken and written English
- Motivation to learn new skills
- Enthusiasm for team building and collaboration

## Desirable but not required:
- Prior experience with programming in R; experience with other languages (Python, C#, etc) are also welcomed
