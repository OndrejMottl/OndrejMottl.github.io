...
Are you passionate about understanding ecosystem changes using large datasets and advanced modelling techniques? I am offering a fully funded, full-time PhD position as part of the [Functional Vegetation Paleoecology project](https://ondrejmottl.github.io/projects/FunctionalVegetationPaleoecology/), funded by [PRIMUS](https://cuni.cz/UKEN-558.html), spanning paleoecology, quantitative ecology, and functional ecology. The candidate will join my [Laboratory of Quantitative Ecology](https://bit.ly/CU_QuantitativeEcology) at the [Department of Botany](https://natur.cuni.cz/en/biology/departments-and-work-places/department-of-botany), [Faculty of Science, Charles University](https://natur.cuni.cz/en) in Prague, Czech Republic.

For the latest updates on this position, visit: [bit.ly/PhD_FunctionalVegetationPaleoecology](https://bit.ly/PhD_FunctionalVegetationPaleoecology)
...
Through interdisciplinary research, the project aims to push the boundaries of our understanding of historical ecosystem dynamics and contribute essential insights into mitigating the impact of anthropogenic climate change.
...
- Opportunity to acquire skills in:
  ...
  - Tools to foster reproducibility in science (Im am an [Open Science Champion](https://openscience.cuni.cz/OSCI-251.html) at Charles University).
  - Presentation and communication skills, with the opportunity to present at conferences, congresses, and workshops.
- The financial compensation consists of 2 parts:
  - Salary of 7,000 CZK/month before taxes (approx. 5,500 CZK/month after taxes, which is around 220 EUR/month as of October 2024).
  - Tax-free PhD stipend of 28,000 CZK/month (approx. 1100 EUR/month as of October 2024).
  - Please note that the cost of living in [Prague is relatively low](https://www.numbeo.com/cost-of-living/in/Prague) compared to other European cities.
- Access to state-of-the-art scientific and computing equipment, software, journals, and scientific databases.
- Access to my worldwide network of collaborators, with the possibility to participate in related projects (see list of all my [current projects](/projects/index.qmd)).
...
- Working in the heart of Prague city centre. Prague, renowned for its [cultural richness](https://goout.net/en/), stands as one of the safest cities globally, with excellent public transport, international accessibility, and healthcare ([read more about living in Prague](https://stars-natur.cz/practical-info)).
...
- Experience with large-scale biodiversity patterns.
...
Send an email to 'quantitative.ecology@natur.cuni.cz' with "PhD application [your surname]" in the email subject, containing:
